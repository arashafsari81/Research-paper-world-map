...
async def get_university(country_id: str, university_id: str, year: Optional[int] = None, start_year: Optional[int] = None, end_year: Optional[int] = None):
...
async def get_author(country_id: str, university_id: str, author_id: str, year: Optional[int] = None, start_year: Optional[int] = None, end_year: Optional[int] = None):
...
async def export_papers(year: Optional[int] = None, start_year: Optional[int] = None, end_year: Optional[int] = None):
    ...
    if start_year and end_year:
        filename = f"papers_export_{start_year}_to_{end_year}.xlsx"
    elif year:
        filename = f"papers_export_{year}.xlsx"
    else:
        filename = "papers_export_all_years.xlsx"
...
async def export_authors(year: Optional[int] = None, start_year: Optional[int] = None, end_year: Optional[int] = None):
...
async def export_countries(year: Optional[int] = None, start_year: Optional[int] = None, end_year: Optional[int] = None):
...
async def export_universities(year: Optional[int] = None, start_year: Optional[int] = None, end_year: Optional[int] = None):
